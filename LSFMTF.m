...
gp = GPhoto;
out = pfs_exec('gphoto2 --set-config /main/capturesettings/f-number=11.0');
...
z= 1;
for bigRingDi = 1000:-10:300
    out = pfs_exec('gphoto2 --set-config /main/capturesettings/shutterspeed=1');
